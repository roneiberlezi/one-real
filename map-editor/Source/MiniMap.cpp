...
MiniMap::MiniMap(int tileWidth, int tileHeight, int screenWidth, int screenHeight, int menuWidth){
    mapSizeX = 0;
    mapSizeY = 0;
    ...
    this->horizontalTiles = (screenWidth-menuWidth)/tileWidth;
    this->verticalTiles = screenHeight/tileHeight;

    miniMap.w = 192;
    miniMap.h = 128;
    miniMap.x = 15;
    miniMap.y = screenHeight - miniMap.h - 15;
}
