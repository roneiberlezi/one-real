...
int main(int argc, char* args[])
{
	...
	//Necessário para manter os sockets sem travar o servidor (MAX 30)
	...
	while (running){
			//Aceita uma nova conex„o, caso nenhuma conex„o nova seja criada, ele retornar· NULL em tmpSocket
